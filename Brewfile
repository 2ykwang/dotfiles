...
brew "claude-squad"         # Multi-agent session manager
brew "direnv"               # Per-directory environment loader
brew "exiftool"             # Media metadata tool
...
brew "node"                 # Node.js
brew "pcp"                  # System performance toolkit
...
brew "wimlib"               # Windows imaging (WIM) tool
...
# Libraries
brew "expat"                # XML parser library
brew "librsvg"              # SVG rendering library
brew "pkgconf"              # pkg-config (pyenv dep)
...
cask "notion-calendar"      # Calendar by Notion
cask "notion-mail"          # Email by Notion
